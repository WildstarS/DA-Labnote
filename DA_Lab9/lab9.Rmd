...
In particular, we assume that $f_k(x)$ is Gaussian with mean $\mu_k$ and variance $\sigma_k^2$. Let us further assume that $\sigma_1^2 = \cdots = \sigma_K^2 = \sigma^2$. By plugging-in,
$$
...
$$
![](LDA1.png)
In linear discriminant analysis (LDA), we estimate $\mu_1,\cdots,\mu_K,\pi_1,\cdots,\pi_K,\sigma^2$. We plug in estimates to estimate the posterior probabilities.
$$
